...
let prompt = {
    promptTypeNumber: async (message) => {
        while (true) {
    ...
    promptTypeList: async (message, choices) => {
...
async function askQuestion() {
    let operator = await prompt.promptTypeList("Select operation you want to perform!", choices);
    switch (operator) {
        case "+ Addition":
            ...
            console.log(chalk.blueBright(`${num1Add} + ${num2Add} = ${num1Add + num2Add}`));
            break;
        case "- Subtraction":
            ...
            console.log(chalk.blueBright(`${num1Sub} - ${num2Sub} = ${num1Sub - num2Sub}`));
            break;
        case "* Multiplication":
            ...
            console.log(chalk.blueBright(`${num1Mul} * ${num2Mul} = ${num1Mul * num2Mul}`));
            break;
        case "/ Division":
            ...
            console.log(chalk.blueBright(`${num1Div} / ${num2Div} = ${num1Div / num2Div}`));
            break;
        case "^ Power":
            let num1Pow = await prompt.promptTypeNumber("Enter the Base!");
            let num2Pow = await prompt.promptTypeNumber("Enter the Exponent!");
            console.log(chalk.blueBright(`${num1Pow} ^ ${num2Pow} = ${Math.pow(num1Pow, num2Pow)}`));
            break;
        case "√ Square Root":
        ...
        case "% Modules":
            ...
            console.log(chalk.blueBright(`${num1Mod} % ${num2Mod} = ${num1Mod % num2Mod}`));
    }
}
(async () => {
    let bool = true;
