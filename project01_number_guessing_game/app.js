...
async function playerInput() {
    ...
    if (playerGuessedInput === random) {
        ...
        console.log(chalk.greenBright(`You have guessed a wrong number ${playerGuessedInput}! Try Again!`));
    }
}
async function startAgain() {
    do {
        ...
        var restart = await inquirer.prompt({
            type: "list",
            name: "recoco",
            message: "Do you want to continue? Type 'Yes' to restart , 'No' to close:",
            choices: ["Yes", "No"],
        });
